...
def get_content_by_director(director: str):
    ...
    """
    content_docs = db.collection('content').where('director', '==', director).get()
    return [doc.to_dict() for doc in content_docs]
...
def get_content_by_release_year(year: int):
    ...
    """
    content_docs = db.collection('content').where('releaseYear', '==', year).get()
    return [doc.to_dict() for doc in content_docs]
...
def get_content_by_type(content_type: str):
    ...
    """
    content_docs = db.collection('content').where('type', '==', content_type).get()
    return [doc.to_dict() for doc in content_docs]
